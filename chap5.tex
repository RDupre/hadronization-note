...
systematic errors
evaluated below. We found first that the correlation between the weights should reduce
...
constant, $Z$ is the proton number, and R is the radius of nuclei. Table 
