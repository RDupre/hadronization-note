...
{\it They are indeed the counts multiplied by the weights, which is mathematically equivalent.
The sum indicated runs over all the recorded events, it is not associated to the weights
bins or anything like that. To be implemented!!!!} \\
